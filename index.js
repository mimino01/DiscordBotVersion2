...
client.on('messageCreate', message => {
    ...
    if (message.content.startsWith('/핫산일해')) {
        ...
        //     '```' +
        //     '');
        // message.react(':23:1066522635070087248');
        // message.channel.send('' +
        //     '위 링크는 자세한 시간 조정법을 설명하는 링크 입니다\n' +
        //     'https://discord.com/channels/851065308234907688/1026105024494968832/1026105240690364476/' +
        //     '');
        // sendReact(message);
        // message.channel.send('─────주간토벌전─────')
        //     .then(sentMessage => {
        //     // 이모지 추가
        //     sentMessage.react(':23:1066522635070087248');
        // });
        // message.channel.send('수요일 오후 21:10 → 길드 토벌 <삐뽀랜드>\n');
        // sendReact(message);
        // message.channel.send('클리어 이후 길드 토벌 <빰뿌르빰빰>\n');
        // sendReact(message);
        // message.channel.send('클리어 이후 길드 토벌 <쿠크루삐뽀>\n');
        // sendReact(message);
        // message.channel.send('```요청에 따라 주간 길드팟 일정을 토요일 -> 수요일로 옮겼습니다.\n```');
        // sendReact(message);
        // message.channel.send('─────아브렐슈드─────\n');
        // message.channel.send('아브렐슈드 노말 1-4관문\n');
        // sendReact(message);
        // message.channel.send('아브렐슈드 노말 5-6관문\n');
        // sendReact(message);
        // message.channel.send('아브렐슈드 하드 1-2관문 + 노말 3-4관문\n');
        // sendReact(message);
        // message.channel.send('아브렐슈드 하드 1-4관문\n');
        // sendReact(message);
        // message.channel.send('아브렐슈드 하드 5-6관문\n');
        // sendReact(message);
        // message.channel.send('─────일리아칸──────\n');
        // message.channel.send('곰곰이랑 에피데믹 가실분\n');
        // sendReact(message);
        // message.channel.send('──────카양겔──────\n');
        // message.channel.send('카양겔 노말\n');
        // sendReact(message);
        // message.channel.send('카양겔 하드1\n');
        // sendReact(message);
        // message.channel.send('카양겔 하드2\n');
        // sendReact(message);
        // message.channel.send('카양겔 하드3\n');
        // sendReact(message);
        // message.channel.send('─────볼다이크──────\n');
        // message.channel.send('볼다이크 노말\n');
        // sendReact(message);
        // message.channel.send('볼다이크 하드\n');
        // sendReact(message);
    }
});

client.login('MTA4MDA3NDI5MzExMjczMzY5Nw.GTdmZk.ck8TK8SvxoeYskidtWvDQoIEeITyh1o5P4hGM0');